...
def launch_options(
    ...
    **launch_options: Dict[str, Any],
    ...
    # LUCID EMPIRE: Removed probabilistic fingerprint generation.
    # The config MUST be populated via the Golden Template in the wrapper.
    # If config is empty/partial, it will fail schema validation in sync_api.py.

    # webgl_config requires OS to be set
    if webgl_config and 'os' not in config:
